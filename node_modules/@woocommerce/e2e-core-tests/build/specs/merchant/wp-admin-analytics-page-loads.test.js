...
const pages = [['Overview'], ['Products'], ['Revenue'], ['Orders'], ['Variations'], ['Categories'], ['Coupons'], ['Taxes'], ['Downloads'], ['Stock', '.components-button > span', 'Product / Variation'], ['Settings', 'h2', 'Analytics Settings']];
...
const runAnalyticsPageLoadsTest = () => {
  describe('Analytics > Opening Top Level Pages', () => {
    ...
    (0, _deprecated.default)('runAnalyticsPageLoadsTest', {
      alternative: '@woocommerce/admin-e2e-tests `testAdminAnalyticsPages()`'
    });
    it.each(pages)('can see %s page properly', async (pageTitle, element, elementText) => {
...
//# sourceMappingURL=wp-admin-analytics-page-loads.test.js.map
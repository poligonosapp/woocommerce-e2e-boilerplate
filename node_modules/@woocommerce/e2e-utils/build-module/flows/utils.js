...
export const getSlug = text => {
  text = text.trim().toLowerCase(); // remove accents, swap ñ for n, etc
...
export const describeIf = condition => condition ? describe : describe.skip; // Conditionally determine whether or not to skip a test case

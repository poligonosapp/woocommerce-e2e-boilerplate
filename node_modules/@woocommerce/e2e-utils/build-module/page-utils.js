...
export const waitForSelectorWithoutThrow = async function (selector) {
...
export const selectOptionInSelect2 = async function (value) {
...
export const clickAndWaitForSelector = async function (buttonSelector, resultSelector) {

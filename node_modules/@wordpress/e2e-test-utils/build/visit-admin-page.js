...
var _getPageError = require("./get-page-error");
...
function _visitAdminPage() {
  _visitAdminPage = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(adminPath, query) {
    var error;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.next = 9;
            return (0, _getPageError.getPageError)();

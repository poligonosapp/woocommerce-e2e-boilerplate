...
function _arePrePublishChecksEnabled() {
  _arePrePublishChecksEnabled = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", (0, _wpDataSelect.wpDataSelect)('core/editor', 'isPublishSidebarEnabled'));
